...
window.moment = require('moment');
    var colors= {
      ...
      "colorCliente": 'rgba(170, 59, 215, 1)'
    }
...
this.setState({numberOfDays:days})
  ...
  render() {
    ...
    //   return <div style={{display:'block', position:'absolute' , background:'#fff', color: '#000'}}>{props.item.name} <button onClick={()=> props.edit(props.item)}>Edit </button></div>
    // }
    return (
